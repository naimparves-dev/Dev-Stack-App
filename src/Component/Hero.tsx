  ...
  export const Hero = () => {
    return (
      <section className="max-w-[1200px] mx-auto px-5 mt-12 md:mt-20">
        <div className="grid grid-cols-1 text-center md:text-left items-center md:grid-cols-2 gap-10">

          {/* Left Content */}
          <div>
            <h2 className="text-[30px] sm:text-5xl md:text-[60px] leading-[1.05] font-bold text-[#111827]">
              Build Your Ideal
              <br />
